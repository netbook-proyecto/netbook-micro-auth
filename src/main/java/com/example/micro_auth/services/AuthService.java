...
public class AuthService {
    ...
    public void register(UsuarioRequest request) {
                if (usuarioRepositories.findByCorreo(request.getCorreo()).isPresent()) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "El correo ya existe: " + request.getCorreo());
        }
    ...
    public String login(LoginRequest request) {
        ...
        Usuario usuario = usuarioRepositories.findByCorreo(request.getCorreo())
        ...
        return jwtService.generateToken(usuario.getCorreo(), usuario.getRol());
    }
}